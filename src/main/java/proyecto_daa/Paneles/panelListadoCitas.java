 ...
 * @author Usuario
 */
public class panelListadoCitas extends javax.swing.JFrame {
    DefaultTableModel modelo;
    GestionadorCitaMedica arbolCitasMedicas = new GestionadorCitaMedica();
    /**
     * Creates new form panelListadoCitas
     */
    ...
    private void initComponents() {
        ...
        tblListado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Paciente", "Medico", "Especialidad", "Horario"
            }
        ));
    ...
    public void listarCitasMedicasPorIdCita(){
        ...
        for (CitaMedica c : listaCitasMedicas) {
           Object[] ob = new Object[5];
            ob[0] = c.getIdCita();
            ob[1] = c.getPaciente().getNombre() + c.getPaciente().getApellido();
            ob[2] = c.getMedico().getNombre() + c.getMedico().getApellido();
            ob[3] = c.getMedico().getEspecialidad();
            ob[4] = c.getHorario();
            modelo.addRow(ob);            
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(panelListadoCitas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
