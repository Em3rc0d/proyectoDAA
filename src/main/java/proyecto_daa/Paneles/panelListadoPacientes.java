...
public class panelListadoPacientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblListado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Apellido", "Telefono", "Contraseña"
            }
        ));
    ...
    private void btnFiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFiltrarActionPerformed
        ...
        if(cbCriterio.getSelectedIndex()==0){
            ...
            while (temp != null) {
                Object[] rowData = {temp.entidad.getIdPaciente(), temp.entidad.getNombre(), temp.entidad.getApellido(), temp.entidad.getNumTelefono(), temp.entidad.getContrasenia()};
    ...
    public void ListarPacientesPorId() {
        ...
        for (Paciente paciente : listadoPacientes) {
            ...
            ob[0] = paciente.getIdPaciente();
            ob[1] = paciente.getNombre();
            ob[2] = paciente.getApellido();
            ob[3] = paciente.getNumTelefono();
            ob[4] = paciente.getContrasenia();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(panelListadoPacientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
