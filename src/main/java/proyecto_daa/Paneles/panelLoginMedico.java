...
public class panelLoginMedico extends javax.swing.JFrame {
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        //if(codigo.getText().equals("admin") && contrasenia.getText().equals("1234")){
        ...
        while(gm.raiz!=null){
            if(gm.raiz.medico.getIdMedico() == code && contrasenia.getText().equals(gm.raiz.medico.getContrasenia())){
                JOptionPane.showMessageDialog(null, "Bienvenido "+gm.raiz.medico.getNombre());
                new panelPaciente().setVisible(true);
                setVisible(false);
                break;
            }
            gm.raiz = gm.raiz.derecha;
        }
        System.out.println("Usuario no existente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(panelLoginMedico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
